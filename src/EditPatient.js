            ...
            <form className="ui form">
              ...
              <div className="two fields">
                <div className="five wide field">
                  ...
                  <select value={isPositive} onChange={(e) => setIsPositive(e.target.value)}>
                    <option>Select</option>
                    <option>Y</option>
                    <option>N</option>
                  </select>
                ...
                <div className="five wide field">
                  ...
                  <input value={reportStatus} onChange={(e) => setReportStatus(e.target.value)}/>
                </div>
              </div>
              <div className="two fields">
                <div className="five wide field">
              ...
              <div className="two fields">
                ...
                <div className="five wide field">
                  ...
                  <select value={recovered} onChange={(e) => setRecovered(e.target.value)}>
                    <option>Select</option>
                    <option>Y</option>
                    <option>N</option>
                  </select>
