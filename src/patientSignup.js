...
import SearchExampleStandard from "./searchEx";
import { useHistory } from "react-router-dom";


const resultRenderer = ({ email,firstName, lastName}) =><div>
  Email:<Label content={email}/> FirstName: <Label content={firstName}/><br/>LastName: <Label content={lastName}/>
